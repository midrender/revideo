...
improvements. To get the best rendering speeds possible, make sure to keep
Revideo updated to the latest version.
...
`renderVideo()` ([docs](/api-reference/renderer/renderVideo)). Note
...
`renderPartialVideo()`
([docs](/api-reference/renderer/renderPartialVideo)) and serverless
