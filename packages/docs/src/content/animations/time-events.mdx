...
In Revideo, it could look somewhat like this:
...
That's why Revideo allows you to edit these delays not through code, but
through the editor. With the use of [`waitUntil`](/api-reference/core/flow) you
...
[`useDuration`](/api-reference/core/utils) function to retrieve the duration
