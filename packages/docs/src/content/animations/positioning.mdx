...
Revideo uses a Cartesian coordinate system. Its origin is located in the
...
<ApiSnippet url="/api-reference/2d/components/classes/Node#position" />

<hr />

### `Node.scale`

<ApiSnippet url="/api-reference/2d/components/classes/Node#scale" />

<hr />

### `Node.rotation`

<ApiSnippet url="/api-reference/2d/components/classes/Node#rotation" />
...
<ApiSnippet url="/api-reference/2d/components/classes/Node#absolutePosition" />

<hr />

### `Node.absoluteScale`

<ApiSnippet url="/api-reference/2d/components/classes/Node#absoluteScale" />

<hr />

### `Node.absoluteRotation`

<ApiSnippet url="/api-reference/2d/components/classes/Node#absoluteRotation" />
...
<ApiSnippet url="/api-reference/2d/components/classes/Node#localToWorld" />

<hr />

### `Node.worldToLocal`

<ApiSnippet url="/api-reference/2d/components/classes/Node#worldToLocal" />

<hr />

### `Node.localToParent`

<ApiSnippet url="/api-reference/2d/components/classes/Node#localToParent" />

<hr />

### `Node.worldToParent`

<ApiSnippet url="/api-reference/2d/components/classes/Node#worldToParent" />
