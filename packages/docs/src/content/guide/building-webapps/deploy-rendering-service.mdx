...
You should expect a rendering job (a function call to
[`renderVideo()`](/api-reference/renderer/renderVideo) or
[`renderPartialVideo()`](/api-reference/renderer/renderPartialVideo)) to
...
([docs](/api-reference/renderer/renderPartialVideo)). When rendering a 10
