...
Revideo comes with a set of common transitions in a form of easy-to-use
...
<ApiSnippet url="/api-reference/core/transitions/functions/slideTransition" />

<hr />

### `zoomInTransition`

<ApiSnippet url="/api-reference/core/transitions/functions/zoomInTransition" />

<hr />

### `zoomOutTransition`

<ApiSnippet url="/api-reference/core/transitions/functions/zoomOutTransition" />

<hr />

### `fadeTransition`

<ApiSnippet url="/api-reference/core/transitions/functions/fadeTransition" />

<hr />

## Custom transitions

You can use the [`useTransition`](/api-reference/core/transitions/functions/useTransition) function
...
By default, Revideo will transition to the next scene once the generator
...
[`finishScene`](/api-reference/core/utils/functions/finishScene) function to trigger the transition
