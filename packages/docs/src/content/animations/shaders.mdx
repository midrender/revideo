...
Shaders can be specified using the [`shaders`](/api-reference/2d/components/classes/Node#shaders)
...
Revideo comes with a simple GLSL preprocessor that lets you include files
...
Shaders in Revideo follow the same idea as
...
[Filters and Effects](/animations/filters-and-effects#cached-nodes) section) When a shader
is applied to a descendant of a cached node, the `destinationTexture` will only
contain the things drawn in the context of that cached node and nothing else.
This is analogous to how composite operations work.
...
[`cachePadding`](/api-reference/2d/components/classes/Node#cachePadding) property can be used to
...
[Vector2]: /api-reference/core/types/classes/Vector2
[BBox]: /api-reference/core/types/classes/BBox
[Spacing]: /api-reference/core/types/classes/Spacing
[WebGLConvertible]: /api-reference/core/types/interfaces/WebGLConvertible
