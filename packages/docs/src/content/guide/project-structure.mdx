...
can also add [transitions](/animations/transitions) between them. A new scene will not
...
[`renderVideo()`](/api-reference/renderer/renderVideo) function accepts variables of its
...
This code is not necessary to start the editor or your project and is not tied
