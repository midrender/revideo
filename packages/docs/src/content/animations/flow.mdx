...
This is the fundamental idea of Revideo. `yield` means: "The current frame
...
Revideo provides a lot of useful generators like this. You may remember
this snippet:
...
[tweening](/animations/tweening) section.
...
<ApiSnippet url="/api-reference/core/flow/functions/all" />

<hr />

### `any`

<ApiSnippet url="/api-reference/core/flow/functions/any" />

<hr />

### `chain`

<ApiSnippet url="/api-reference/core/flow/functions/chain" />

<hr />

### `delay`

<ApiSnippet url="/api-reference/core/flow/functions/delay" />

<hr />

### `sequence`

<ApiSnippet url="/api-reference/core/flow/functions/sequence" />

<hr />

### `loop`

<ApiSnippet url="/api-reference/core/flow/functions/loop" />
